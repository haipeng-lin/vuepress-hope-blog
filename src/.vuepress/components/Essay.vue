    ...
    <div class="essay-container">
        <div class="essay-masonry">
            <div v-for="essay in essays" :key="essay.id" class="essay-card">
                ...
                <!-- 图片区域 -->
                <div class="essay-images" :class="{ 'single-image': essay.images.length === 1 }">
                    <img v-for="(img, index) in essay.images" :key="index" :src="img" :alt="`图片${index + 1}`"
                        loading="lazy" class="essay-image" :class="{ 'single': essay.images.length === 1 }" />
                </div>
